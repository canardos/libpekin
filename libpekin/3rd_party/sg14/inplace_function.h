...
/*
 * === Libpekin MODIFICATION BEGIN ===
 */
#ifndef SG14_INPLACE_FUNCTION_THROW
//#define SG14_INPLACE_FUNCTION_THROW(x) throw (x)
#include "libpekin.h"
#pragma message("No SG14_INPLACE_FUNCTION_THROW definition provided. Using default LP_ASSERT(false)")
#define SG14_INPLACE_FUNCTION_THROW(x) LP_ASSERT(false)
#endif
/*
 * === Libpekin MODIFICATION END ===
 */
